...
**Assigned: Monday 3/27/17**

### Due Date
Monday April 3rd (4/3/17) at 11:59PM, Discuss idea at Meeting with Dr. Hale 4/4/17 at assigned time block.
...
As a **misuser**, I want to **misuse goal** so I can **rationale**.
...
##### Misuser stories
|Each misuser story | Meets expectations (9-10) | Some Issues (6-8) | Does not meet expectations (0-5)|
|---|---|---|---|
...
#### Grading Criteria
There is no rubric for this grade, you will get 40 points for coming to the meeting and being prepared.
